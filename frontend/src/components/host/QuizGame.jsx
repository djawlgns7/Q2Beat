...
const QuizGame = () => {
    ...
    const getQuizNormal = async (category) => {
        const response = await fetch(`http://localhost:8080/quiz/get/normal?category=${category}&roomId=${roomId}`, {
            method: "GET",
            headers: {
    ...
    const getQuizListening = async (category) => {
        try {
            const response = await fetch(`http://localhost:8080/quiz/get/listening?roomId=${roomId}&category=${category}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const getQuizTwister = async (category) => {
        const response = await fetch(`http://localhost:8080/twister/get?level=${setting.level}&roomId=${roomId}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const getNextPlayer = async () => {
        try {
            const response = await fetch(`http://localhost:8080/quiz/player/available?roomId=${roomId}`);
            if (!response.ok) {
    ...
    const getQuizPose = async (category) => {
        const response = await fetch(`http://localhost:8080/quiz/pose/get?level=${setting.level}&roomId=${roomId}`, {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
            },
